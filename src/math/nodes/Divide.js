...
class Divide extends Node {
  ...
  simplify() {
    ...
    const fraction = this.Get_Num_Denom(this);
    ...
    if (sChild2.isEqual(new Constant(1))) {
      return sChild1;
    }
    if (sChild1.isEqual(sChild2)) {
    ...
    if (
      sChild1.children != null &&
      sChild2.children != null &&
      sChild1.children.length === sChild2.children.length &&
      sChild1.children[0].isEqual(sChild2.children[0])
    ) {
      // Sin
      if (sChild1 instanceof Sin && sChild2 instanceof Cos) {
        return new Tan(sChild1.children[0]);
      }
      if (sChild1 instanceof Sin && sChild2 instanceof Tan) {
        return new Cos(sChild1.children[0]);
      }
      if (sChild1 instanceof Sin && sChild2 instanceof Csc) {
      ...
      if (sChild1 instanceof Cos && sChild2 instanceof Csc) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Cos && sChild2 instanceof Sec) {
        return new Power(sChild1, new Constant(2));
      }
      if (sChild1 instanceof Cos && sChild2 instanceof Cot) {
        return new Cot(sChild1.children[0]);
      }
      ...
      if (sChild1 instanceof Tan && sChild2 instanceof Cos) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Tan && sChild2 instanceof Csc) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Tan && sChild2 instanceof Sec) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Tan && sChild2 instanceof Cot) {
        return new Power(sChild1, new Constant(2));
      }
      ...
      if (sChild1 instanceof Csc && sChild2 instanceof Cos) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Csc && sChild2 instanceof Tan) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Csc && sChild2 instanceof Sec) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Csc && sChild2 instanceof Cot) {
        return new Cot(sChild1.children[0]);
      }
      ...
      if (sChild1 instanceof Sec && sChild2 instanceof Cos) {
        return new Power(sChild1, new Constant(2));
      }
      if (sChild1 instanceof Sec && sChild2 instanceof Tan) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Sec && sChild2 instanceof Csc) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Sec && sChild2 instanceof Cot) {
        return new Cot(sChild1.children[0]);
      }
      ...
      if (sChild1 instanceof Cot && sChild2 instanceof Cos) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Cot && sChild2 instanceof Tan) {
        return new Power(sChild1, new Constant(2));
      }
      if (sChild1 instanceof Cot && sChild2 instanceof Csc) {
        return new Cot(sChild1.children[0]);
      }
      if (sChild1 instanceof Cot && sChild2 instanceof Sec) {
        return new Cot(sChild1.children[0]);
      }
    }
    //#endregion
  ...
  isEqual(node) {
    if (!this.containsVariable) {
      if (!node.containsVariable) {
        const cal = new calculationSettings();
        if (calculate(cal) === node.calculate(cal)) {
          return true;
        }
      } else return false;
    } else if (this.constructor === node.constructor) {
