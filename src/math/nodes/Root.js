...
class Root extends Node {
  ...
  calculate(cs, tempVars) {
    return this.children[0].calculate(cs, tempVars) ** (1 / this.children[1].calculate(cs, tempVars));
  }
  ...
  derivative(cs) {
    return new Subtract(
      ...
      new Divide(
        new Multiply(this.children[1].derivative(cs), new Multiply(this, new Ln(new Abs(this.children[0])))),
